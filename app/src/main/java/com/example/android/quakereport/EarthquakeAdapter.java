...
public class EarthquakeAdapter extends ArrayAdapter<Earthquake> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        TextView offsetView=(TextView)listItemView.findViewById(R.id.primary_location);

        offsetView.setText(primaryLocation);

        Date dateObject=new Date(currentView.getDate());
